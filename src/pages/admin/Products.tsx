...
export const AdminProducts: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const galleryImages = [formData.gallery_image_1, formData.gallery_image_2].filter(Boolean);
  ...
  const handleEdit = (product: Product) => {
    ...
    setFormData({
      ...
      gallery_image_1: product.gallery_images?.[0] || '',
      gallery_image_2: product.gallery_images?.[1] || '',
    });
    setShowModal(true);
  };
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, gallery_image_1: e.target.value })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Imagem da Galeria 2 (Opcional)
                </label>
                <input
                  type="url"
                  name="gallery_image_2"
                  value={formData.gallery_image_2}
                  onChange={(e) => setFormData({ ...formData, gallery_image_2: e.target.value })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
